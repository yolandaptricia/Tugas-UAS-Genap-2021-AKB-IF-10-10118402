 ...
 * Kelas : IF-10
 * Tanggal Pengerjaan   : 6-12 Agustus 2021
 */
...
import com.example.uas_akb_10118402.adapter.MainAdapter;
import com.example.uas_akb_10118402.model.MainModel;
import com.example.uas_akb_10118402.presenter.MainSlidePresenter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData, NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setMenu() {
        ...
        mdlMainMenu = new MainModel("Budaya dan Sejarah", R.drawable.ic_budaya);
        lsMainMenu.add(mdlMainMenu);
        mdlMainMenu = new MainModel("Taman Rekreasi", R.drawable.ic_rekreasi);
        lsMainMenu.add(mdlMainMenu);
        mdlMainMenu = new MainModel("Kuliner", R.drawable.ic_restaurant);
        lsMainMenu.add(mdlMainMenu);
    ...
    public void onSelected(MainModel mdlMain) {
        switch (mdlMain.getTxtName()) {
            case "Alam":
                ...
                startActivity(i);
                break;
            case "Budaya dan Sejarah":
                Intent j = new Intent(MainActivity.this, BudayaActivity.class);
                startActivity(j);
                break;
            case "Taman Rekreasi":
                Intent k = new Intent(MainActivity.this, RekreasiActivity.class);
                startActivity(k);
                break;
            case "Kuliner":
                Intent l = new Intent(MainActivity.this, KulinerActivity.class);
                startActivity(l);
                break;
        }
    }
